              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                        "Are you sure you want to save below pet animal"),
                    const SizedBox(
                      height: 10,
                    ),
                    ListTile(
                      leading:
                          Image.network(_provider.datatofirestore['image'][0]),
                      title: Text(
                       ...
                       const SizedBox(
                        ...
                        _provider,
                        {
                          'contactDetails': {
                            ...
                            'contactMobile': _phoneController,
                            'contactEmail': _emailController,
                          }
                        },
                        context).then((value){
                          setState(() {
                ...
                Row(
                  children: [
                   ...
                   IconButton(onPressed: (){  
                    Navigator.push(context, MaterialPageRoute(builder: (BuildContext context)=>LocationScreen(locationChanging: null,)));
