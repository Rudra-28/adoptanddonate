                ...
                child: ListTile(
                 key: Key(doc.id),
                  onTap: () {
                    ...
                    if(doc['subCat']==null){
                      Navigator.pushNamed(context, DonorDogForm.id);
                    }
                    Navigator.pushNamed(context, DonorSubCategoryList.id, arguments: doc);
                    ...
                    //   Navigator.pushNamed(context, DonorCatForm.id, arguments: doc); // Pass doc
                    // } else if (catName.toLowerCase() == 'dogs') {
                    //   Navigator.pushNamed(context, DonorDogForm.id, arguments: doc); // Pass doc
                    // } else if (catName.toLowerCase() == 'birds') {
                    //   Navigator.pushNamed(context, DonorSubCategoryList.id, arguments: doc); // Pass doc
                    // } else if (data['subCat'] == null ||
                    //     (data['subCat'] is List && (data['subCat'] as List).isEmpty)) {
                    //   Navigator.pushNamed(context, DonorCatForm.id, arguments: doc); // Pass doc
                    // } else {
                    //   Navigator.pushNamed(context, DonorSubCategoryList.id, arguments: doc); // Pass doc
                    // }
